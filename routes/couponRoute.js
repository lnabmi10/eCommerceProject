...
const {createCoupon,getAllCoupons,updateCoupon,deleteCoupon,applayCoupon, getOneCoupon}= require('../controller/couponCtrl')
...
router.get("/applaycoupon/",applayCoupon)
